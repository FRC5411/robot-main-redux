...
public final class SwerveConstants 
{
    ...
    /* Front Left Module */
        public static final class Mod0 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(260.59);
        ...
        public static final class Mod1 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(259.18);
            public static final RevSwerveModuleConstants constants = 
                new RevSwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
        /* Back Left Module */
        public static final class Mod2 { 
            ...
            public static final Rotation2d angleOffset = Rotation2d.fromDegrees(217.26);
            public static final RevSwerveModuleConstants constants = 
                new RevSwerveModuleConstants(driveMotorID, angleMotorID, canCoderID, angleOffset);
        }
         /* Back Right Module */
